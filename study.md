...
```md
ORM is object relational mapping. It connects the objects in application tables to the databases.
We use ORM because the the properties and relationships can be accessed and stored in the database without writting SQL.
...
```md
create. Creates new objects and if you need to create additonal methods you can use .new method.
```
