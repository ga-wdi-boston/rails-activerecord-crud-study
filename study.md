...
```md
Object Relational Mapping is how we connect objects in applications to tables/databases.  It helps to structure the objects so they can be easily stored and retrienved.
```
...
```md
create (POST)
Yes, using Person.create will create a row in the database that persists.
```
