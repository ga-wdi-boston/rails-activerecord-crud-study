...
```md
It connects objects to tables in the database and allows you to access the properties and relationships of those objects without writing SQL directly.
```
...
SELECT * FROM organisms ORDER BY id LIMIT 1;
