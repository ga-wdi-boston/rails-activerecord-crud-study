...
```md
ORM connect's an application's objects to tables within a relational database system.  A benefit of this is that it allows us to query and manipulate data from a database without needing to write SQL statements.
```
...
```md
ApplicationRecord creates new models.  Example:
